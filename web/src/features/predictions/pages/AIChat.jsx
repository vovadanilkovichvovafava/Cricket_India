...
// --- Bet Promo Hook (contextual, like football project) ---
function BetPromoHook({ matchContext, confidence, onCtaClick }) {
      ...
      <div className="flex-1 overflow-y-auto overscroll-contain px-5 py-4 space-y-4 dark:bg-gray-900">
        {messages.map(msg => (
          <div key={msg.id}>
            ...
            {/* Bet Promo Hook — after value bets */}
            {msg.role === 'assistant' && msg.valueBets && msg.valueBets.length > 0 && !isTyping && (
        ...
        <div className="px-5 pb-2 shrink-0">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="text-sm px-3 py-1.5 rounded-full font-medium bg-gradient-to-r from-[#FF9933] to-[#FF8800] text-white shadow-sm flex items-center gap-1.5"
            >
